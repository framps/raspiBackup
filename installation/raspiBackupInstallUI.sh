...
SUPPORTED_LANGUAGES=("EN" "DE" "FI" "CN")
...
MSG_CN[$MSG_DOWNLOADING]="${MSG_PRF}0002I: 下载中 %1..."
...
MSG_FI[$MSG_DOWNLOAD_FAILED]="${MSG_PRF}0003E: Kohteen %1 lataus ep?onnistui. HTTP-koodi: %2."
MSG_CN[$MSG_DOWNLOAD_FAILED]="${MSG_PRF}0003E: 下载 %1 失败. HTTP-代码: %2."
...
MSG_FI[$MSG_INSTALLATION_FAILED]="${MSG_PRF}0004E: Kohteen %1 asennus ep?onnistui. Tarkista %2."
MSG_CN[$MSG_INSTALLATION_FAILED]="${MSG_PRF}0004E: 安装 %1 失败. 检查 %2."
...
MSG_FI[$MSG_SAVING_FILE]="${MSG_PRF}0005I: Tiedosto %1 tallennettiin nimell? %2."
MSG_CN[$MSG_SAVING_FILE]="${MSG_PRF}0005I:  %1 已存在,另存为 %2."
MSG_CHMOD_FAILED=$((SCNT++))
MSG_EN[$MSG_CHMOD_FAILED]="${MSG_PRF}0006E: chmod of %1 failed."
MSG_DE[$MSG_CHMOD_FAILED]="${MSG_PRF}0006E: chmod von %1 nicht m?glich."
MSG_FI[$MSG_CHMOD_FAILED]="${MSG_PRF}0006E: chmod %1 ep?onnistui."
MSG_CN[$MSG_CHMOD_FAILED]="${MSG_PRF}0006E: chmod %1 失败."
MSG_MOVE_FAILED=$((SCNT++))
MSG_EN[$MSG_MOVE_FAILED]="${MSG_PRF}0007E: mv of %1 failed."
MSG_DE[$MSG_MOVE_FAILED]="${MSG_PRF}0007E: mv von %1 nicht m?glich."
MSG_FI[$MSG_MOVE_FAILED]="${MSG_PRF}0007E: mv %1 ep?onnistui."
MSG_CN[$MSG_MOVE_FAILED]="${MSG_PRF}0007E: mv %1 失败."
MSG_CLEANUP=$((SCNT++))
MSG_EN[$MSG_CLEANUP]="${MSG_PRF}0008I: Cleaning up..."
MSG_DE[$MSG_CLEANUP]="${MSG_PRF}0008I: R?ume auf..."
MSG_FI[$MSG_CLEANUP]="${MSG_PRF}0008I: Puhdistetaan..."
MSG_CN[$MSG_CLEANUP]="${MSG_PRF}0008I: 正在清理..."
...
MSG_CN[$MSG_INSTALLATION_FINISHED]="${MSG_PRF}0009I: 安装 %1 成功."
...
MSG_FI[$MSG_UPDATING_CONFIG]="${MSG_PRF}0010I: P?ivitet??n asetukset tiedostossa %1."
MSG_CN[$MSG_UPDATING_CONFIG]="${MSG_PRF}0010I: 更新设置 %1."

MSG_DELETE_FILE=$((SCNT++))
MSG_EN[$MSG_DELETE_FILE]="${MSG_PRF}0011I: Deleting %1..."
MSG_DE[$MSG_DELETE_FILE]="${MSG_PRF}0011I: L?sche %1..."
MSG_FI[$MSG_DELETE_FILE]="${MSG_PRF}0011I: Poistetaan %1..."
MSG_CN[$MSG_DELETE_FILE]="${MSG_PRF}0011I: 删除 %1..."
...
MSG_CN[$MSG_UNINSTALL_FINISHED]="${MSG_PRF}0012I: 卸载 %1 成功."

MSG_UNINSTALL_FAILED=$((SCNT++))
MSG_EN[$MSG_UNINSTALL_FAILED]="${MSG_PRF}0013E: Delete of %1 failed."
MSG_DE[$MSG_UNINSTALL_FAILED]="${MSG_PRF}0013E: L?schen von %1 fehlerhaft beendet."
MSG_FI[$MSG_UNINSTALL_FAILED]="${MSG_PRF}0013E: Kohteen %1 poisto ep?onnistui."
MSG_CN[$MSG_UNINSTALL_FAILED]="${MSG_PRF}0013E: 删除 %1 失败."
...
MSG_CN[$MSG_DOWNLOADING_BETA]="${MSG_PRF}0014I: 下载 %1 beta版本..."
...
MSG_CN[$MSG_CODE_INSTALLED]="${MSG_PRF}0015I: 创建 %1."
...
MSG_CN[$MSG_NOT_INSTALLED]="${MSG_PRF}0016I: %1 未安装."

MSG_CHOWN_FAILED=$((SCNT++))
MSG_EN[$MSG_CHOWN_FAILED]="${MSG_PRF}0017E: chown of %1 failed."
MSG_DE[$MSG_CHOWN_FAILED]="${MSG_PRF}0017E: chown von %1 nicht m?glich."
MSG_FI[$MSG_CHOWN_FAILED]="${MSG_PRF}0017E: chown %1 ep?onnistui."
MSG_CN[$MSG_CHOWN_FAILED]="${MSG_PRF}0017E: chown of %1 失败."
...
MSG_FI[$MSG_SAMPLEEXTENSION_INSTALL_FAILED]="${MSG_PRF}0018E: N?ytelis?osien asennus ep?onnistui. %1"
MSG_CN[$MSG_SAMPLEEXTENSION_INSTALL_FAILED]="${MSG_PRF}0018E: 扩展安装失败. %1"
...
MSG_FI[$MSG_SAMPLEEXTENSION_INSTALL_SUCCESS]="${MSG_PRF}0019I: N?ytelis?osat asennettu ja otettu k?ytt??n onnistuneesti."
MSG_CN[$MSG_SAMPLEEXTENSION_INSTALL_SUCCESS]="${MSG_PRF}0019I: 扩展安装成功并激活."
...
MSG_CN[$MSG_INSTALLING_CRON_TEMPLATE]="${MSG_PRF}0020I: 创建cron文件 %1."
...
MSG_FI[$MSG_NO_INTERNET_CONNECTION_FOUND]="${MSG_PRF}0021E: Yhdist?minen kohteeseen $MYHOMEDOMAIN ep?onnistui. wget RC: %1"
MSG_CN[$MSG_NO_INTERNET_CONNECTION_FOUND]="${MSG_PRF}0021E: 连接 $MYHOMEDOMAIN 失败. wget RC: %1"
...
MSG_FI[$MSG_CHECK_INTERNET_CONNECTION]="${MSG_PRF}0022I: Tarkistetaan verkkoyhteytt?."
MSG_CN[$MSG_CHECK_INTERNET_CONNECTION]="${MSG_PRF}0022I: 检查网络连接."
...
MSG_FI[$MSG_SAMPLEEXTENSION_UNINSTALL_FAILED]="${MSG_PRF}0023E: N?ytelis?osien asennuksen poisto ep?onnistui. %1"
MSG_CN[$MSG_SAMPLEEXTENSION_UNINSTALL_FAILED]="${MSG_PRF}0023E: 扩展卸载失败. %1"
...
MSG_DE[$MSG_SAMPLEEXTENSION_UNINSTALL_SUCCESS]="${MSG_PRF}0024I: Beispielserweiterungen erfolgreich gel?scht."
MSG_FI[$MSG_SAMPLEEXTENSION_UNINSTALL_SUCCESS]="${MSG_PRF}0024I: N?ytelis?osat poistettiin onnistuneesti."
MSG_CN[$MSG_SAMPLEEXTENSION_UNINSTALL_SUCCESS]="${MSG_PRF}0024I: 扩展已被删除."

MSG_UNINSTALLING_CRON_TEMPLATE=$((SCNT++))
MSG_EN[$MSG_UNINSTALLING_CRON_TEMPLATE]="${MSG_PRF}0025I: Deleting cron file %1."
MSG_DE[$MSG_UNINSTALLING_CRON_TEMPLATE]="${MSG_PRF}0025I: Crondatei %1 wird gel?scht."
MSG_FI[$MSG_UNINSTALLING_CRON_TEMPLATE]="${MSG_PRF}0025I: Poistetaan cron-tiedosto %1."
MSG_CN[$MSG_UNINSTALLING_CRON_TEMPLATE]="${MSG_PRF}0025I: 删除cron文件 %1."
...
MSG_FI[$MSG_UPDATING_CRON]="${MSG_PRF}0026I: P?ivitet??n cron-asetukset kohteessa %1."
MSG_CN[$MSG_UPDATING_CRON]="${MSG_PRF}0026I: 更新cron文件 %1."
...
MSG_CN[$MSG_MISSING_DIRECTORY]="${MSG_PRF}0027E: 缺少必要的路径 %1."
...
MSG_FI[$MSG_CODE_UPDATED]="${MSG_PRF}0028I: %1 p?ivitetty viimeisimp??n julkaisuun."
MSG_CN[$MSG_CODE_UPDATED]="${MSG_PRF}0028I: 更新 %1 到最新版本."
...
MSG_DE[$MSG_QUESTION_UPDATE_CONFIG]="Soll die ge?nderte Konfiguration von $RASPIBACKUP_NAME jetzt gespeichert werden?"
MSG_FI[$MSG_QUESTION_UPDATE_CONFIG]="Haluatko tallentaa p?ivitetyt $RASPIBACKUP_NAME-asetukset nyt?"
MSG_CN[$MSG_QUESTION_UPDATE_CONFIG]="是否立刻更新 $RASPIBACKUP_NAME 设置?"
...
MSG_DE[$MSG_QUESTION_IGNORE_MISSING_STARTSTOP]="Es werden keine Services vor dem Start des Backups gestoppt.${NL}WARNUNG${NL}Dadurch k?nnen inkonsistente Backups mit $RASPIBACKUP_NAME entstehen.${NL}Ist das beabsichtigt?"
MSG_FI[$MSG_QUESTION_IGNORE_MISSING_STARTSTOP]="Palveluita ei ole valittu pys?ytett?v?ksi ennen varmuuskopiointia.${NL}VAROITUS${NL}T?m? voi johtaa $RASPIBACKUP_NAME-varmuuskopioiden ep?yhten?isyyteen.${NL}Oletko varma?"
MSG_CN[$MSG_QUESTION_IGNORE_MISSING_STARTSTOP]="备份前没有停止任何服务.${NL}警告${NL}可能会创建一个与$RASPIBACKUP_NAME名称不一致的备份.${NL}是否继续?"
...
MSG_DE[$MSG_QUESTION_UPDATE_CRON]="Soll die ge?nderte cron Konfiguration für $RASPIBACKUP_NAME jetzt gespeichert werden?"
MSG_FI[$MSG_QUESTION_UPDATE_CRON]="Haluatko tallentaa nyt p?ivitetyt cron-asetukset kohteelle $RASPIBACKUP_NAME?"
MSG_CN[$MSG_QUESTION_UPDATE_CRON]="是否保存$RASPIBACKUP_NAME 更新的cron设置?"
...
MSG_FI[$MSG_SEQUENCE_OK]="Palvelut pys?ytet??n seuraavassa j?rjestyksess? ja ne k?ynnistet??n uudelleen k??nteisess? j?rjestyksess?. Onko j?rjestys OK?"
MSG_CN[$MSG_SEQUENCE_OK]="停止服务命令将按以下顺序停止，启动服务命令按反序执行 OK?"

BUTTON_YES=$((SCNT++))
MSG_EN[$BUTTON_YES]="Yes"
MSG_DE[$BUTTON_YES]="Ja"
MSG_FI[$BUTTON_YES]="Kyll?"
MSG_EN[$BUTTON_YES]="Yes"
MSG_CN[$BUTTON_YES]="Yes"
...
MSG_CN[$MSG_QUESTION_UNINSTALL]="确认卸载 $RASPIBACKUP_NAME 么?"
...
MSG_CN[$MSG_SCRIPT_NOT_INSTALLED]="$RASPIBACKUP_NAME 尚未安装."

MSG_CRON_NA=$((SCNT++))
MSG_EN[$MSG_CRON_NA]="Weekly backup disabled."
MSG_DE[$MSG_CRON_NA]="W?chentliches Backup ist ausgeschaltet."
MSG_FI[$MSG_CRON_NA]="Viikoittainen varmuuskopiointi ei ole k?yt?ss?."
MSG_CN[$MSG_CRON_NA]="每周备份已禁用."
...
MSG_FI[$MSG_CONFIG_NOT_INSTALLED]="Asetuksia ei l?ytynyt."
MSG_CN[$MSG_CONFIG_NOT_INSTALLED]="未找到配置文件."
...
MSG_FI[$MSG_CRON_NOT_INSTALLED]="Cron-asetuksia ei l?ytynyt."
MSG_CN[$MSG_CRON_NOT_INSTALLED]="Cron未找到."
...
MSG_FI[$MSG_NO_UPDATE_AVAILABLE]="(P?ivityst? ei ole saatavilla)"
MSG_CN[$MSG_NO_UPDATE_AVAILABLE]="(没有可用更新)"
...
MSG_FI[$MSG_NO_EXTENSIONS_FOUND]="Lis?osia ei ole asennettu."
MSG_CN[$MSG_NO_EXTENSIONS_FOUND]="尚未安装扩展."
...
MSG_FI[$MSG_EXTENSIONS_ALREADY_INSTALLED]="Lis?osat ovat jo asennettuna."
MSG_CN[$MSG_EXTENSIONS_ALREADY_INSTALLED]="扩展已安装."
...
MSG_CN[$MSG_DOWNLOADING_PROPERTYFILE]="下载版本信息."
...
MSG_FI[$MSG_INVALID_KEEP]="Ep?kelpo numero %1 sy?tetty. Numeron tulee olla 1:n ja 52:n v?lilt?."
MSG_CN[$MSG_INVALID_KEEP]="输入的 %1 无效. 数字必须在1和52之间."
...
MSG_FI[$MSG_INVALID_KEEP_NUMBER_COUNT]="Sy?t? vain yksi numero."
MSG_CN[$MSG_INVALID_KEEP_NUMBER_COUNT]="请仅插入一个数字."
...
MSG_FI[$MSG_INVALID_SMART]="Ep?kelpo numero %1 sy?tetty. Numeron tulee olla >= 0."
MSG_CN[$MSG_INVALID_SMART]="输入的 %1 无效. 数字必须>= 0."
...
MSG_DE[$MSG_INVALID_SMART_NUMBER_COUNT]="Vier durch Leerzeichen getrennte Zahlen werden erwartet: T?gliche, w?chentliche, monatliche und j?hrliche Backups."
MSG_FI[$MSG_INVALID_SMART_NUMBER_COUNT]="Vaaditaan nelj? v?lily?nnein erotettua numeroa: p?ivitt?inen, viikoittainen, kuukausittainen ja vuosittainen varmuuskopiointien lukum??r?"
MSG_CN[$MSG_INVALID_SMART_NUMBER_COUNT]="四个分隔数字分别代表：按日、按周、按月、按年的备份"
...
MSG_FI[$MSG_INVALID_KEEP_NUMBER_COUNT]="Sy?t? vain yksi numero."
MSG_CN[$MSG_INVALID_KEEP_NUMBER_COUNT]="请仅输入一个数字."
...
MSG_FI[$MSG_INVALID_TIME]="Ep?kelpo kellonaika '%1'. Ajan tulee olla muodossa hh:mm ja 0<=hh<24 sek? 0<=mm<60."
MSG_CN[$MSG_INVALID_TIME]="无效的时间 '%1'. 输入的格式必须为 hh:mm  0<=hh<24 且 0<=mm<60."
...
MSG_FI[$MSG_RUNASROOT]="$MYSELF tulee k?ynnist?? root-oikeuksin. K?ynnist? 'sudo %1%2'."
MSG_CN[$MSG_RUNASROOT]="$MYSELF 必须以root身份开启. 请尝试 'sudo %1%2'."
...
MSG_FI[$DESCRIPTION_INSTALLATION]="${NL}$RASPIBACKUP_NAME tukee lis?osia, joiden toimintoja voidaan suorittaa ennen ja j?lkeen varmuuskopioinnin. \
Mukana tulevat n?ytelis?osat esitt?v?t prosessorin l?mp?tilan sek? tietoja muistin ja varmuuskopiointilevyn k?yt?st?. \
${NL}Lue lis?tietoja osoitteesta https://www.linux-tips-and-tricks.de/en/raspibackupcategoryy/443-raspibackup-extensions."
MSG_CN[$DESCRIPTION_INSTALLATION]="${NL}$RASPIBACKUP_NAME 允许插入自定义扩展，备份前后均可插入. \
...
MSG_DE[$DESCRIPTION_COMPRESS]="${NL}$RASPIBACKUP_NAME kann dd und tar Backups kompressen um die Backupgr??e zu reduzieren. Das bedeutet aber dass die Backupzeit steigt und die CPU erw?rmen wird. \
...
MSG_FI[$DESCRIPTION_COMPRESS]="${NL}$RASPIBACKUP_NAME voi pakata dd- ja tar-varmuuskopiot, jotta ne veisiv?t v?hemm?n tilaa. Huomioithan, ett? t?m? pident?? varmuuskopioinnin aikaa ja nostaa CPU:n l?mp?tilaa. \
Huomioi my?s vaihtoehto $FILE_TO_INSTALL, joka v?hent?? dd-varmuuskopioiden k?ytt?m?? tilaa. \
Lis?tietoja l?yd?t osoitteesta https://www.linux-tips-and-tricks.de/en/faq#a16."
MSG_CN[$DESCRIPTION_COMPRESS]="${NL}$RASPIBACKUP_NAME 可以压缩 dd和tar备份文件. 但是这会在备份期间增加备份时间和使CPU升温. \
...
MSG_DE[$DESCRIPTION_CRON]="${NL}$RASPIBACKUP_NAME sollte regelm??ig gestartet werden wenn die initiale Konfiguration sowie Backup und Restore Tests beendet sind. \
Konfiguriere den Backup t?glich oder w?chentlich zu erstellen. Für andere Intervalle muss die Datei /etc/cron.d/raspiBackup manuell ge?ndert werden."
MSG_FI[$DESCRIPTION_CRON]="${NL}$RASPIBACKUP_NAME tulisi ajaa ??nn?llisesti se j?lkeen, kun asetusten m??ritysten j?lkeen ensimm?inen varmuuskopio on suoritettu ja varmuuskopion palautus on testattu. \
Ajasta varmuuskopiointi p?ivitt?iseksi tai viikottaiseksi. Muita varmuuskopioinnin aikav?lej? varten tulee muokata tiedostoa /etc/cron.d/raspiBackup manuaalisesti."
MSG_CN[$DESCRIPTION_CRON]="${NL}$RASPIBACKUP_NAME 会在完成初始配置以及备份和恢复测试后定期启动. \
...
MSG_DE[$DESCRIPTION_SMARTMODE]="${NL}Es gibt grunds?tzlich zwei Methoden, die Anzahl der vorzuhaltenden Backups festzulegen. Dies erfolgt entweder durch die Definition der maximalen Anzahl oder durch Verwendung der intelligenten Backupstrategie. \
Eine Detailbeschreibung der Strategie befindet sich auf https://www.linux-tips-and-tricks.de/de/rotationsstrategie/."
MSG_FI[$DESCRIPTION_SMARTMODE]="${NL}Voit m??ritt?? s?ilytett?vien varmuuskopioiden lukum??r?n joko m??ritt?m?ll? s?ilytett?vien varmuuskopioiden maksimim??r?n tai \
k?ytt?m?ll? ?lyk?st? varmuuskopiointia.${NL}Katso lis?tietoa osoitteesta https://www.linux-tips-and-tricks.de/en/smart-recycle/."
MSG_CN[$DESCRIPTION_SMARTMODE]="${NL}当前有两种方法定义备份数量:定义最大备份数或者用只能备份策略,策略详情: \
...
Es macht Sinn alle beim ersten Installieren von $RASPIBACKUP_NAME anzuschalten. Sp?ter k?nnen sie auf die Wichtigsten reduziert werden."
MSG_FI[$DESCRIPTION_MESSAGEDETAIL]="${NL}$RASPIBACKUP_NAME voi joko kirjoittaa yksityiskohtaiset tai vain t?rke?t viestit. \
Yleens? ensimm?isen $RASPIBACKUP_NAME-asennuksen j?lkeen yksityiskohtaiset viestit on hyv? n?ytt??. Voit my?hemmin valita kirjoitettavaksi vain t?rke?t viestit."
MSG_CN[$DESCRIPTION_MESSAGEDETAIL]="${NL}$RASPIBACKUP_NAME 可以非常详细或者只显示重要信息. \
...
MSG_FI[$DESCRIPTION_STARTSTOP]="${NL}T?rke?t palvelut tulisi pys?ytt?? varmuuskopioinnin ajaksi. Lis?? pys?ytett?v?t palvelut v?lily?nnill? erotettuna pys?ytysj?rjestyksess?. \
Palvelut k?ynnistet??n k??nteisess? j?rjestyksess? varmuuskopioinnin p??ttyess?. Lis?tietoa l?yd?t osoitteesta https://www.linux-tips-and-tricks.de/en/faq#a18."
MSG_CN[$DESCRIPTION_STARTSTOP]="${NL}备份前，重要服务会被停止，备份后自动重启服务.按顺序添加需要停止的服务，多个服务用空格分割 \
...
MSG_DE[$DESCRIPTION_STARTSTOP_SEQUENCE]="${NL}W?hle der Reihe nach die Services aus wie sie vor dem Backup gestoppt werden sollen und best?tige jeden einzelnen Service mit <Best?tigen> bis keine Services mehr angezeigt werden. \
...
MSG_FI[$DESCRIPTION_STARTSTOP_SEQUENCE]="${NL}Valitse pys?ytett?v?t palvelut yksi kerrallaan painaen <OK>, kunnes listalla ei ole palveluita. \
Toteutuva j?rjestys n?ytet??n ylh??lt? alas. \
${NL}Lis?tietoja n?et osoitteesta https://www.linux-tips-and-tricks.de/en/faq#a18."
MSG_CN[$DESCRIPTION_STARTSTOP_SEQUENCE]="${NL}一个一个的选择需要停止的服务,按<Ok>确定. \
停止顺序自上而下. \
...
MSG_DE[$DESCRIPTION_STARTSTOP_SERVICES]="${NL}W?hle alle wichtigen Services aus die vor dem Backup gestoppt werden sollen. \
Sie werden wieder in umgekehrter Reihenfolge gestartet wenn der Backup beendet wurde."
MSG_FI[$DESCRIPTION_STARTSTOP_SERVICES]="${NL}Palvelut pys?ytet??n ennen varmuuskopiointia siin? j?rjestyksess?, kun valitset ne. \
Listalla n?ytet??n nykyinen j?rjestys. \
Palvelut k?ynnistet??n k??nteisess? j?rjestyksess? varmuuskopioinnin p??ttyess?."
MSG_CN[$DESCRIPTION_STARTSTOP_SERVICES]="${NL}按顺序选择备份开始前应停止的所有服务. \
当前序列已显示. \
备份完成后会按反序重启."
...
MSG_DE[$DESCRIPTION_PARTITIONS]="${NL}W?hle alle Partitionen aus die im Backup enthalten sein sollen. \
${NL}${NL}Hinweis: Die ersten beiden Partitionen müssen immer ausgew?hlt werden."
MSG_FI[$DESCRIPTION_PARTITIONS]="${NL}Valitse kaikki varmuuskopioitavat osiot. \
${NL}${NL}Huom: Kaksi ensimm?ist? osiota tulee olla aina valittuna."
MSG_CN[$DESCRIPTION_PARTITIONS]="${NL}选择所有需要备份的分区. \
...
MSG_FI[$DESCRIPTION_LANGUAGE]="${NL}$RASPIBACKUP_NAME ja t?m? asennusty?kalu tukevat t?ll? hetkell? ${NL}alla lueteltuja kieli?. Oletuksena on j?rjestelm?n kieli.\
${NL}${NL}Apu muiden kielien lis??miseen on tervetullut."
MSG_CN[$DESCRIPTION_LANGUAGE]="${NL}$RASPIBACKUP_NAME 目前支持下列语言，默认使用系统语言.\
${NL}${NL}欢迎翻译其他语言！."
...
MSG_FI[$DESCRIPTION_KEEP]="${NL}Sy?t? s?ilytett?vien varmuuskopioiden lukum??r?. Numeron tulee olla 1:n ja 52:n v?lilt?."
MSG_CN[$DESCRIPTION_KEEP]="${NL}输入保存的备份数,在1和52之间."
...
MSG_DE[$DESCRIPTION_SMART]="${NL}Gib mit vier durch Leerzeichen getrennten Zahlen die Parameter für die intelligente Rotationsstrategie ein. Die Zahlen definieren wie viele t?gliche, w?chentliche, monatliche und j?hrliche Backups vorgehalten werden. \
Details zur Backupstrategie k?nnen auf https://www.linux-tips-and-tricks.de/de/rotationsstrategie/ nachgelesen werden."
MSG_FI[$DESCRIPTION_SMART]="${NL}Sy?t? nelj? v?lily?nnein erotettua numeroa m??ritt??ksesi ?lykk??n varmuuskopioinnin parametrit. Numerot m??ritt?v?t kuinka monta p?ivitt?ist?, viikoittaista, kuukausittaista ja vuosittaista varmuuskopiota s?ilytet??n. \
Lis?tietoa l?yd?t osoitteesta https://www.linux-tips-and-tricks.de/en/smart-recycle/."
MSG_CN[$DESCRIPTION_SMART]="${NL}输入四个数字定义备份策略. 这决定备份周期. \
...
MSG_FI[$DESCRIPTION_ERROR]="发生了无法恢复的错误。检查日志文件$LOG_FILE."
...
MSG_FI[$DESCRIPTION_BACKUPPATH]="${NL}Sijainti, johon $FILE_TO_INSTALL:n varmuuskopiot tallennetaan, tulee olla otettuna k?ytt??n. \
Sijainti voi olla otettu k?ytt??n joko paikallisesti tai et?n?."
MSG_CN[$DESCRIPTION_BACKUPPATH]="${NL}在备份路径必须挂载一个分区，用来为$FILE_TO_INSTALL存储备份文件. \
可以是本地磁盘或者云端磁盘."
...
MSG_DE[$DESCRIPTION_BACKUPMODE]="${NL}Empfohlener Modus ist der normale Backup Modus. Wenn allerdings mehr als zwei Partitionen gesichert werden sollen mit tar oder rsync ist der paritionsorientiert Modus zu w?hlen. \
Den normalen Modus muss man aber w?hlen wenn man ein dd Backup haben m?chte. Standard ist nur die ersten beiden Partitionen zu sichern aber es kann jede weitere Partition dazugefügt werden."
MSG_FI[$DESCRIPTION_BACKUPMODE]="${NL}Oletuksena on suositeltu normaali varmuuskopiointitila, jolloin kaksi ensimm?ist? osiota varmuuskopioidaan. Jos haluat varmuuskopioida useamman kuin kaksi osiota k?ytt?en tar:ia tai rsync:i?, k?yt? j?lkimm?ist?, osio-orientoitua tilaa. \
K?yt? normaalia tilaa ja dd-varmuuskopiointia, jos haluat dd-varmuuskopion."
MSG_FI[$DESCRIPTION_BACKUPMODE]="${NL}Oletuksena on suositeltu normaali varmuuskopiointitila, jolloin kaksi ensimm?ist? osiota varmuuskopioidaan. Jos haluat varmuuskopioida useamman kuin kaksi osiota k?ytt?en tar:ia tai rsync:i?, k?yt? j?lkimm?ist?, osio-orientoitua tilaa. \
K?yt? normaalia tilaa ja dd-varmuuskopiointia, jos haluat dd-varmuuskopion."
MSG_CN[$DESCRIPTION_BACKUPMODE]="${NL}预设的是常规备份模式, 若想用tar 或rsync备份2个以上分区，请选择分区导向模式. \
...
MSG_DE[$DESCRIPTION_BACKUPTYPE]="${NL}rsync ist der empfohlene Backuptyp da durch Hardlinks vom ETX3/4 Dateisystem der Backup schnell ist da nur neue oder ge?nderte Dateien gesichert werden. \
tar sollte man benutzen wenn das Backupdateisystem kein EXT3/4 ist, z.B. ein remotes Samba Laufwerk. Ein FAT32 Dateisystem ist ungeeignet da die maximale Dateigr??e nur 4GB ist. \
dd ist die richtige Wahl wenn man den Backup auf einem Windows OS wiederherstellen will. \
dd und tar Backups k?nnen noch zus?tzlich komprimiert werden. \
...
MSG_FI[$DESCRIPTION_BACKUPTYPE]="${NL}EXT3/4-tiedostoj?rjetelm?ss? on suositeltavaa valita rsync, sill? hardlinkit nopeuttavat varmuuskopiointia: vain uudet ja muuttuneet tiedostot kopioidaan. \
Valitse tar, jos varmuuskopioitava tiedostoj?rjestelm? ei ole EXT3/4 tai se on esim. et?n? k?ytt??notettu samba-jako. ?l? k?yt? FAT32-tiedostoj?rjestelm??, koska sen maksimitiedostokoko on 4Gt. \
Valitse dd, jos haluat palauttaa varmuuskopion Windows-j?rjestelm?ss?. dd- ja tar-varmuuskopiot voidaan pakata tilan s??st?miseksi. \
${NL}${NL}Lis?tietoja varmuuskopiotyypeist? l?yd?t osoitteestahttps://www.linux-tips-and-tricks.de/en/backup#butypes. \
${NL}Lis?tietoja dd:n valinnoista l?yd?t osoitteesta https://www.linux-tips-and-tricks.de/en/faq#a16"
MSG_CN[$DESCRIPTION_BACKUPTYPE]="${NL}rsync是建议的备份方法.因为ETX3/4文件系统的硬链接只有在改变时才会被保存\
...
MSG_DE[$DESCRIPTION_MAIL_PROGRAM]="W?hle das Mailprogramm aus welches zum Versenden von Benachrichtigungen benutzt werden soll."
MSG_FI[$DESCRIPTION_MAIL_PROGRAM]="Valitse s?hk?postisovellus ilmoituss?hk?postien l?hett?miseen."
MSG_CN[$DESCRIPTION_MAIL_PROGRAM]="选择发送邮件的程序."
...
MSG_FI[$DESCRIPTION_EMAIL]="Sy?t? s?hk?postiosoite, johon ilmoitukset l?hetet??n. Jos et halua ilmoituksia, ?l? sy?t? lainkaan s?hk?postiosoitetta."
MSG_CN[$DESCRIPTION_EMAIL]="输入邮件地址，留空则禁用邮件通知."

TITLE_ERROR=$((SCNT++))
MSG_EN[$TITLE_ERROR]="Error"
MSG_DE[$TITLE_ERROR]="Fehler"
MSG_FI[$TITLE_ERROR]="Virhe"
MSG_CN[$TITLE_ERROR]="错误"
...
MSG_CN[$TITLE_INFORMATION]="信息"

TITLE_VALIDATIONERROR=$((SCNT++))
MSG_EN[$TITLE_VALIDATIONERROR]="Invalid input"
MSG_DE[$TITLE_VALIDATIONERROR]="Ungültige Eingabe"
MSG_FI[$TITLE_VALIDATIONERROR]="Virheellinen sy?te"
MSG_CN[$TITLE_VALIDATIONERROR]="无效输入"

TITLE_CONFIRM=$((SCNT++))
MSG_EN[$TITLE_CONFIRM]="Please confirm"
MSG_DE[$TITLE_CONFIRM]="Bitte best?tigen"
MSG_FI[$TITLE_CONFIRM]="Ole hyv? ja varmista"
MSG_CN[$TITLE_CONFIRM]="请确认"
...
MSG_CN[$MSG_INVALID_BACKUPPATH]="备份路径 %1 不存在"

MSG_INVALID_EMAIL=$((SCNT++))
MSG_EN[$MSG_INVALID_EMAIL]="Invalid eMail address %1"
MSG_DE[$MSG_INVALID_EMAIL]="Ungültige eMail Adresse %1"
MSG_FI[$MSG_INVALID_EMAIL]="Virheellinen s?hk?postiosoite %1"
MSG_CN[$MSG_INVALID_EMAIL]="邮箱地址无效 %1"
...
MSG_FI[$MSG_LOCAL_BACKUPPATH]="Varmuuskopio s?ilytet??n SD-kortilla"
MSG_CN[$MSG_LOCAL_BACKUPPATH]="备份文件将被存储在SD卡"
...
${NL}\
Pfeiltasten: Bewege Schreibmarke zum n?chsten Menueintrag, Listeneintrag oder Auswahlknopf${NL}\
Leertaste: Selektiere/Deselektieren Eintr?ge in einer Auswahliste${NL}\
Tab Taste: Springe zu den unteren Auswahlkn?pfen"
MSG_DE[$MSG_NAVIGATION]="Pfeiltasten: Bewege Schreibmarke zum n?chsten Menueintrag, Listeneintrag oder Auswahlknopf${NL}\
Leertaste: Selektiere/Deselektieren Eintr?ge in einer Auswahliste${NL}\
Tab Taste: Springe zu den unteren Auswahlkn?pfen${NL}\
${NL}\
Cursor keys: Move cursor to next menu or list item${NL}\
Space key: Select/unselect items in a selection list${NL}\
Tab key: Jump to buttons at the bottom"
MSG_FI[$MSG_NAVIGATION]="Nuolin?pp?imet: Siirr? kursori seuraavaan valikon tai listan kohteeseen${NL}\
V?lily?nti: Valitse/poista valinta${NL}\
Sarkain: Kohdista alarivin painikkeisiin${NL}\
${NL}\
Cursor keys: Move cursor to next menu or list item${NL}\
Space key: Select/unselect items in a selection list${NL}\
Tab key: Jump to buttons at the bottom"
MSG_CN[$MSG_NAVIGATION]="箭头方向键:上下移动菜单选项、列表选项或者按钮${NL}\
空格键: 选中或取消勾选${NL}\
Tab: 跳至菜单底部按钮${NL}\
${NL}\
Cursor keys: Move cursor to next menu or list item${NL}\
...
Dieses Tool erm?glicht es m?glichst einfach $RASPIBACKUP_NAME zu installieren,${NL} zu updaten und die Konfiguration anzupassen.${NL}${NL}\
...
T?m? ty?kalu tarjoaa $RASPIBACKUP_NAME:n suoraviivaisen asennuksen,${NL} p?ivitt?misen ja asetusten m??ritt?misen.${NL}${NL}\
Kaikista $RASPIBACKUP_NAME:n asetuksista l?yd?t tietoa osoitteesta${NL}https://www.linux-tips-and-tricks.de/en/raspibackup#parameters${NL}${NL}\
L?yd?t lis?tietoa $RASPIBACKUP_NAME:sta osoitteesta${NL}https://www.linux-tips-and-tricks.de/de/raspibackup"
MSG_CN[$MSG_ABOUT]="$GIT_CODEVERSION${NL}${NL}\
...
3) Verifiziere dass das System ohne Probleme l?uft.${NL}\
...
6) Schalte den regelm??igen Backup mit dem Installer ein${NL}\
...
1) K?ynnist? $RASPIBACKUP_NAME komentorivilt? ja luo varmuuskopio${NL}\
2) K?ynnist? $RASPIBACKUP_NAME palauttaaksesi varmuuskopion toiselle SD-kortille${NL}\
3) Varmista, ett? palautettu varmuuskopio toimii oikein.${NL}\
4) Lue FAQ-sivu osoitteessa https://www.linux-tips-and-tricks.de/en/faq${NL}\
5) K?y valintasivulla ja tee $RASPIBACKUP_NAME$-hienos??d?t{NL}\
   https://www.linux-tips-and-tricks.de/en/raspibackup#parameters${NL}\
6) Ota k?ytt??n s??nn?lliset varmuuskopiot asennusohjelmalla${NL}\
7) K?y osoitteessa https://www.linux-tips-and-tricks.de/en/backup ja lue paljon lis?? $RASPIBACKUP_NAME-tietoa"
MSG_CN[$MSG_FIRST_STEPS]="恭喜! $RASPIBACKUP_NAME 安装成功.${NL}${NL}\
接下来你可以:${NL}
...
MSG_DE[$MSG_HELP]="Falls es irgendwelche Fragen oder Probleme zu $RASPIBACKUP_NAME gibt bestehen folgende M?glichkeiten Hilfe zu bekommen${NL}
...
3) Erstelle einen Fehlerbericht auf github https://github.com/framps/raspiBackup/issues. Gerne auch in Deutsch. Das ist meine Pr?ferenz.${NL} \
...
MSG_FI[$MSG_HELP]="Jos sinulla on kysymyksi? tai ongelmia $RASPIBACKUP_NAME:n kanssa, k?yt? jotain seuraavista tavoista saadaksesi apua${NL}
1) Lue FAQ-sivu osoitteessa https://www.linux-tips-and-tricks.de/en/faq${NL}\
2) K?y osoitteessa https://www.linux-tips-and-tricks.de/en/backup ja lue paljon lis?? $RASPIBACKUP_NAME-tietoa${NL}\
3) Luo issue githubissa https://github.com/framps/raspiBackup/issues. T?t? suosin.${NL}\
4) Lis?? kommentti $RASPIBACKUP_NAME-verkkosivuilla osoitteessa $MYHOMEDOMAIN${NL}\
5) K?y $RASPIBACKUP_NAME:n Facebook-sivulla"
MSG_CN[$MSG_HELP]="如果你有任何关于 $RASPIBACKUP_NAME 的问题，请用以下方式联系${NL}
...
MENU_FI[$MENU_UNDEFINED]="M??ritt?m?t?n valikon id."
MENU_CN[$MENU_UNDEFINED]="未定义的菜单id."

MENU_LANGUAGE=$((MCNT++))
MENU_EN[$MENU_LANGUAGE]='"M1" "Language"'
MENU_DE[$MENU_LANGUAGE]='"M1" "Sprache"'
MENU_FI[$MENU_LANGUAGE]='"M1" "Kieli"'
MENU_CN[$MENU_LANGUAGE]='"M1" "语言"'
...
MENU_CN[$MENU_INSTALL]='"M2" "安装组件"'

MENU_CONFIGURE=$((MCNT++))
MENU_EN[$MENU_CONFIGURE]='"M3" "Configure major options"'
MENU_DE[$MENU_CONFIGURE]='"M3" "Konfiguriere die wichtigsten Optionen"'
MENU_FI[$MENU_CONFIGURE]='"M3" "M??rit? p??asetukset"'
MENU_CN[$MENU_CONFIGURE]='"M3" "设置主要选项"'

MENU_UNINSTALL=$((MCNT++))
MENU_EN[$MENU_UNINSTALL]='"M4" "Delete components"'
MENU_DE[$MENU_UNINSTALL]='"M4" "L?sche Komponenten"'
MENU_FI[$MENU_UNINSTALL]='"M4" "Poista komponentteja"'
MENU_CN[$MENU_UNINSTALL]='"M4" "删除组件"'

MENU_UPDATE=$((MCNT++))
MENU_EN[$MENU_UPDATE]='"M5" "Update components"'
MENU_DE[$MENU_UPDATE]='"M5" "Aktualisiere Komponenten"'
MENU_FI[$MENU_UPDATE]='"M5" "P?ivit? komponentteja"'
MENU_CN[$MENU_UPDATE]='"M5" "更新组件"'

MENU_ABOUT=$((MCNT++))
MENU_EN[$MENU_ABOUT]='"M9" "About and useful links"'
MENU_DE[$MENU_ABOUT]='"M9" "About und hilfreiche Links"'
MENU_FI[$MENU_ABOUT]='"M9" "Tietoja ja hy?dyllisi? linkkej?"'
MENU_CN[$MENU_ABOUT]='"M9" "关于&链接"'

MENU_REGULARBACKUP_ENABLE=$((MCNT++))
MENU_EN[$MENU_REGULARBACKUP_ENABLE]='"R1" "Enable regular backup"'
MENU_DE[$MENU_REGULARBACKUP_ENABLE]='"R1" "Regelm??iges Backup einschalten"'
MENU_FI[$MENU_REGULARBACKUP_ENABLE]='"R1" "Ota k?ytt??n s??nn?llinen varmuuskopiointi"'
MENU_CN[$MENU_REGULARBACKUP_ENABLE]='"R1" "开启定期备份"'

MENU_REGULARBACKUP_DISABLE=$((MCNT++))
MENU_EN[$MENU_REGULARBACKUP_DISABLE]='"R1" "Disable regular backup"'
MENU_DE[$MENU_REGULARBACKUP_DISABLE]='"R1" "Regelm??iges Backup auschalten"'
MENU_FI[$MENU_REGULARBACKUP_DISABLE]='"R1" "Poista s??nn?llinen varmuuskopiointi k?yt?st?"'
MENU_CN[$MENU_REGULARBACKUP_DISABLE]='"R1" "禁用定期备份"'

MENU_CONFIG_DAY=$((MCNT++))
MENU_EN[$MENU_CONFIG_DAY]='"R2" "Weekday of regular backup"'
MENU_DE[$MENU_CONFIG_DAY]='"R2" "Wochentag des regelm??igen Backups"'
MENU_FI[$MENU_CONFIG_DAY]='"R2" "S??nn?llisen varmuuskopioinnin viikonp?iv?"'
MENU_CN[$MENU_CONFIG_DAY]='"R2" "每日备份"'

MENU_CONFIG_TIME=$((MCNT++))
MENU_EN[$MENU_CONFIG_TIME]='"R3" "Time of regular backup"'
MENU_DE[$MENU_CONFIG_TIME]='"R3" "Zeit des regelm??igen Backups"'
MENU_FI[$MENU_CONFIG_TIME]='"R3" "S??nn?llisen varmuuskopioinnin kellonaika"'
MENU_CN[$MENU_CONFIG_TIME]='"R3" "定期备份间隔"'
...
MENU_CN[$MENU_CONFIG_LANGUAGE_EN]='"EN" "英语"'
...
MENU_CN[$MENU_CONFIG_LANGUAGE_DE]='"DE" "德语'
...
MENU_CN[$MENU_CONFIG_LANGUAGE_FI]='"FI" "芬兰语"'

MENU_CONFIG_LANGUAGE_ZH=$((MCNT++))
MENU_EN[$MENU_CONFIG_LANGUAGE_FI]='"CN" "Chinese"'
MENU_DE[$MENU_CONFIG_LANGUAGE_FI]='"CN" "Chinesisch"'
MENU_FI[$MENU_CONFIG_LANGUAGE_FI]='"CN" "Kiina"'
MENU_CN[$MENU_CONFIG_LANGUAGE_FI]='"CN" "中文"'
...
MENU_FI[$MENU_CONFIG_MESSAGE_N]='"Normaali" "N?yt? vain t?rke?t viestit"'
MENU_CN[$MENU_CONFIG_MESSAGE_N]='"一般" "仅显示重要信息"'
...
MENU_FI[$MENU_CONFIG_MESSAGE_V]='"Tarkka" "N?yt? kaikki viestit"'
MENU_CN[$MENU_CONFIG_MESSAGE_V]='"详细" "显示所有信息"'
...
MENU_CN[$MENU_CONFIG_BACKUPPATH]='"C2" "备份路径"'

MENU_CONFIG_BACKUPS=$((MCNT++))
MENU_EN[$MENU_CONFIG_BACKUPS]='"C3" "Backup versions"'
MENU_DE[$MENU_CONFIG_BACKUPS]='"C3" "Backupversionen"'
MENU_FI[$MENU_CONFIG_BACKUPS]='"C3" "Varmuuskopioiden versioiden s?ilytys"'
MENU_CN[$MENU_CONFIG_BACKUPS]='"C3" "备份版本"'
...
MENU_CN[$MENU_CONFIG_TYPE]='"C4" "备份类型"'
...
MENU_CN[$MENU_CONFIG_MODE]='"C5" "备份模式'
...
MENU_FI[$MENU_CONFIG_SERVICES]='"C6" "Palveluiden pys?ytt?minen ja uudelleenk?ynnist?minen"'
MENU_CN[$MENU_CONFIG_SERVICES]='"C6" "需要处理的系统服务"'
...
MENU_CN[$MENU_CONFIG_MESSAGE]='"C7" "信息设置"'

MENU_CONFIG_EMAIL=$((MCNT++))
MENU_EN[$MENU_CONFIG_EMAIL]='"C8" "eMail notification"'
MENU_DE[$MENU_CONFIG_EMAIL]='"C8" "eMail Benachrichtigung"'
MENU_FI[$MENU_CONFIG_EMAIL]='"C8" "S?hk?posti-ilmoitus"'
MENU_CN[$MENU_CONFIG_EMAIL]='"C8" "邮件通知"'

MENU_CONFIG_CRON=$((MCNT++))
MENU_EN[$MENU_CONFIG_CRON]='"C9" "Regular backup"'
MENU_DE[$MENU_CONFIG_CRON]='"C9" "Regelm??iges Backup"'
MENU_FI[$MENU_CONFIG_CRON]='"C9" "S??nn?llinen varmuuskopiointi"'
MENU_CN[$MENU_CONFIG_CRON]='"C9" "定期备份"'
...
MENU_FI[$MENU_CONFIG_MODE_KEEP]='"Yksinkertainen" "S?ilyt? valitsemasi lukum??r?n verran varmuuskopioita"'
MENU_CN[$MENU_CONFIG_MODE_KEEP]='"简单" "保留最大数量的备份文件"'
...
MENU_FI[$MENU_CONFIG_MODE_SMART]='"?lyk?s" "?lyk?s varmuuskopiointistrategia"'
MENU_CN[$MENU_CONFIG_MODE_SMART]='"智能" "智能备份策略"'
...
MENU_CN[$MENU_CONFIG_MODE_NORMAL]='"标准" "备份2个标准分区"'
...
MENU_FI[$MENU_CONFIG_MODE_PARTITION]='"Laajennettu" "Varmuuskopioi enemm?n kuin kaksi osiota"'
MENU_CN[$MENU_CONFIG_MODE_PARTITION]='"扩展" "备份多于2个分区"'
...
MENU_CN[$MENU_INSTALL_INSTALL]='"I1" "使用默认设置安装 $RASPIBACKUP_NAME "'
...
MENU_FI[$MENU_INSTALL_EXTENSIONS]='"I2" "Asenna ja ota k?ytt??n n?ytelis?osat"'
MENU_CN[$MENU_INSTALL_EXTENSIONS]='"I2" "安装并开启示例扩展"'
...
MENU_CN[$MENU_CONFIG_MAIL_MAIL]='"mail" ""'
...
MENU_CN[$MENU_CONFIG_MAIL_SSMTP]='"ssmtp" ""'
...
MENU_CN[$MENU_CONFIG_MAIL_MSMTP]='"msmtp" ""'
...
MENU_CN[$MENU_CONFIG_TYPE_DD]='"dd" "使用dd备份并且在Windows上恢复"'
...
MENU_CN[$MENU_CONFIG_TYPE_TAR]='"tar" "使用tar备份"'

MENU_CONFIG_TYPE_RSYNC=$((MCNT++))
MENU_EN[$MENU_CONFIG_TYPE_RSYNC]='"rsync" "Backup with rsync and use hardlinks if possible"'
MENU_DE[$MENU_CONFIG_TYPE_RSYNC]='"rsync" "Sichere mit rsync und benutze Hardlinks wenn m?glich"'
MENU_FI[$MENU_CONFIG_TYPE_RSYNC]='"rsync" "rsync-varmuuskopio ja hardlinkkien k?ytt?"'
MENU_CN[$MENU_CONFIG_TYPE_RSYNC]='"rsync" "使用rsync备份,如果可能,使用硬链接"'

MENU_UNINSTALL_UNINSTALL=$((MCNT++))
MENU_EN[$MENU_UNINSTALL_UNINSTALL]='"U1" "Uninstall $RASPIBACKUP_NAME"'
MENU_DE[$MENU_UNINSTALL_UNINSTALL]='"U1" "L?sche $RASPIBACKUP_NAME"'
MENU_FI[$MENU_UNINSTALL_UNINSTALL]='"U1" "Poista $RASPIBACKUP_NAME -asennus"'
MENU_CN[$MENU_UNINSTALL_UNINSTALL]='"U1" "卸载 $RASPIBACKUP_NAME"'

MENU_UNINSTALL_EXTENSION=$((MCNT++))
MENU_EN[$MENU_UNINSTALL_EXTENSION]='"U2" "Uninstall and disable sample extensions"'
MENU_DE[$MENU_UNINSTALL_EXTENSION]='"U2" "L?sche Extensions"'
MENU_FI[$MENU_UNINSTALL_EXTENSION]='"U2" "Poista k?yt?st? ja pura n?ytelis?osien asennukset"'
MENU_CN[$MENU_UNINSTALL_EXTENSION]='"U2" "卸载并禁用示例扩展"'

MENU_CONFIG_TYPE_DD_NA=$((MCNT++))
MENU_EN[$MENU_CONFIG_TYPE_DD_NA]='"" "Backup with dd not possible with this mode"'
MENU_DE[$MENU_CONFIG_TYPE_DD_NA]='"" "Sichern mit dd nicht m?glich bei diesem Modus"'
MENU_FI[$MENU_CONFIG_TYPE_DD_NA]='"" "DD-varmuuskopio ei ole mahdollista t?ss? tilassa"'
MENU_CN[$MENU_CONFIG_TYPE_DD_NA]='"" "此模式不可使用dd备份"'
...
MENU_CN[$MENU_CONFIG_COMPRESS_OFF]='"off" "不压缩"'
...
MENU_CN[$MENU_CONFIG_COMPRESS_ON]='"on" "压缩 $CONFIG_BACKUPTYPE 备份"'

MENU_DAYS_SHORT=$((MCNT++))
MENU_EN[$MENU_DAYS_SHORT]='"Daily" "Sun" "Mon" "Tue" "Wed" "Thu" "Fri" "Sat"'
MENU_DE[$MENU_DAYS_SHORT]='"T?glich" "So" "Mo" "Di" "Mi" "Do" "Fr" "Sa"'
MENU_FI[$MENU_DAYS_SHORT]='"P?ivitt?in" "Su" "Ma" "Ti" "Ke" "To" "Pe" "La"'
MENU_CN[$MENU_DAYS_SHORT]='"Daily" "Sun" "Mon" "Tue" "Wed" "Thu" "Fri" "Sat"'

MENU_DAYS_LONG=$((MCNT++))
MENU_EN[$MENU_DAYS_LONG]='"Daily" "Sunday" "Monday" "Tuesday" "Wednesday" "Thursday" "Friday" "Saturday"'
MENU_DE[$MENU_DAYS_LONG]='"T?glich" "Sonntag" "Montag" "Dienstag" "Mittwoch" "Donnerstag" "Freitag" "Samstag"'
MENU_FI[$MENU_DAYS_LONG]='"P?ivitt?in" "Sunnuntai" "Maanantai" "Tiistai" "Keskiviikko" "Torstai" "Perjantai" "Lauantai"'
MENU_CN[$MENU_DAYS_LONG]='"Daily" "Sunday" "Monday" "Tuesday" "Wednesday" "Thursday" "Friday" "Saturday"'
...
MENU_FI[$MENU_UPDATE_SCRIPT]='"P1" "P?ivit? $FILE_TO_INSTALL"'
MENU_CN[$MENU_UPDATE_SCRIPT]='"P1" "更新 $FILE_TO_INSTALL"'
...
MENU_FI[$MENU_UPDATE_INSTALLER]='"P2" "P?ivit? $MYSELF"'
MENU_CN[$MENU_UPDATE_INSTALLER]='"P2" "更新 $MYSELF"'
